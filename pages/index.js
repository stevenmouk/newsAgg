...
export async function getServerSideProps(context) {
  ...
  let res = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res3 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res4 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res7 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res9 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res10 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res12 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res13 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res14 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res16 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res17 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  let res20 = await fetch("https://news-agg.vercel.app/api/financialtimes/", {
    method: "POST",
    mode: "cors",
  ...
  feed.items.forEach((item) => {
    ...
    if (item.guid.toString().includes("_SAQA")) {
      ...
      if (newUrl.toString().trim().replace(/\s/, "").substring(4, newUrl.length).charAt(0) != "h") {
        newUrl = newUrl.toString().trim().replace(/\s/, "").substring(5, newUrl.length);
      } else {
        newUrl = newUrl.toString().trim().replace(/\s/, "").substring(4, newUrl.length);
      }
  ...
  return {
    props: { arr: JSON.parse(JSON.stringify(final)) },
  };
}
